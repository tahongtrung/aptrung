...
class Captcha
{
    function create($str, $pathImage = 'assets/captcha/captcha.jpg', $fontSize = 28, $fontName = 'assets/fonts/ChaparralPro-BoldIt.otf', $background = 'assets/img/bg_captcha1.jpg')
	{
