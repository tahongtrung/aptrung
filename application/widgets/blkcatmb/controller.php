...
class Blkcatmb_widget extends MY_Widget
{
    ...
    function index(){
        ...
        $data['doitac'] = $this->f_homemodel->get_data('images',array('type'=>'partners'));
        $data['product_focus']=$this->f_homemodel->get_data('product',array('focus'=>1,'lang'=>$this->language));
        $data['product_view']=$this->f_homemodel->get_data('product',array('view'=>1,'lang'=>$this->language));
