                ...
                <div class="col-lg-800 col-md-9 col-sm-9 col-xs-12 col-page">
                    ...
                    <div class="">
                        <div class="title-left4">
                            <h2>
                                <ul>
                                    <li><a href="#" title="<?=@$this->option->site_name?>">Kết quả tìm kiếm</a></li>
                                </ul>
                            </h2>
                        ...
                        <div class="prd-home">
                            <div class="row row-10">
                                ...
                                if(count($lists)) {
                                    ...
                                    <?php } }else{ echo '<span style="color: #000;font-size: 16px;">Không có kết quả phù hợp với từ khóa !</span>'; } ?>
                            </div>
                        </div>
                    </div>
                </div>
