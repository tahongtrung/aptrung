...
<div class="col-md-8" style="font-size: 12px">
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="min-height: 530px">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">Định dạng Menu:</label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <select name="module" id="sc_get" class="form-control input-sm">
                        ...
                        <option value="products" <?=@$edit->module=='products'?'selected':''?> >Menu dịch vụ</option>
                        <option value="media" <?=@$edit->module=='media'?'selected':''?> >Menu media</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <input type="hidden" id="styles" value="<?=$module_link['media'];?>">
