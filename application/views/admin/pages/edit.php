                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right">
                                <button type="button" onclick="updatePage()" class="btn btn-success btn-xs" name="add_news"><i
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12" id="error-alias">
                                    <input type="text" id="alias" onchange="createAlias(this)" class="form-control input-sm validate[required]" name="alias"
    ...
    function updatePage(){
        ...
        if($('#form-bk').validationEngine('validate')){
            $.ajax({
                type: "POST",
                dataType: "json",
                url: base_url() + 'adminvn/alias/checkPageEdit',
