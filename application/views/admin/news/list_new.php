...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
                    ...
                    <form action="" method="get" class="row">
                        ...
                        <div class="col-sm-2 pull-right">
                            <select name="view" class="input-sm form-control" >
                                ...
                                <option value="hot" <?=$this->input->get('view')=='hot'?'selected':'';?>>Tin nổi bật</option>
                                <option value="focus" <?=$this->input->get('view')=='focus'?'selected':'';?>>Video</option>
            ...
            <div class="">
                <div class="clear"></div>
                <form name="formbk" method="post" action="<?=base_url('adminvn/news/deletes')?>">
                                ...
                                foreach ($newslist as $v) {
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">
                                            ...
                                            <!-- <div data-toggle="tooltip" data-placement="top" title="View file"
                                            ...
                                            <div data-toggle="tooltip" data-placement="top" title="Tin nổi bật"
                                                 data-value="<?=$v->id;?>" data-view="focus"
                                                 class='view_color' style='border: 1px solid #008855;margin-right: 10px;<?=($v->focus == 1)?'background:#008855':'';?>'>

                                                 </div>
                                            <!--<div data-toggle="tooltip" data-placement="top" title="Dự án tiêu biểu"
                                                 data-value="<?/*=$v->id;*/?>" data-view="coupon"
                                                 class='view_color' style='border: 1px solid #008855;margin-right: 10px;<?/*=($v->coupon == 1)?'background:#008855':'';*/?>'></div>-->
