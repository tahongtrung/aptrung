        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-table"></i> Sửa danh mục
                    </li>
                    <?php if (isset ($error)) { ?>
                        <li class="">
            ...
            <div class="col-md-12">
                ...
                <div class="body collapse in" id="div1">
                    <form class="form-horizontal" role="form" id="form-bk" method="POST" action=""
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <div class="pull-right">
                                        <button type="button" onclick="updadteItem()" class="btn btn-success btn-xs" name="add_cate"><i
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" oninput="createAlias(this)" class="form-control validate[required]" name="title"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea name="description" id="ckeditor2" class="form-control" placeholder="Mô tả" rows="4"><?=@$edit->description;?></textarea>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="button" onclick="updadteItem()" class="btn btn-success btn-sm" name="add_cate"><i
                                                class="fa fa-check"></i> Lưu
                                        </button>
                                    </div>
                                </div>
    ...
    function updadteItem()
    {
        ...
        if($('#form-bk').validationEngine('validate')){
            $.ajax({
                type: "POST",
                dataType: "json",
                url: base_url() + 'adminvn/alias/checkCatNewEdit',
