        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text"  name="video" class="form-control input-sm" value="<?=$edit->video==''?'':'https://www.youtube.com/watch?v='.$edit->video;?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="text-right" style="padding-bottom: 15px">
                    <input type="hidden" value="1" name="editnew">
                    <button type="button" onclick="updateItem()" class="btn btn-success btn-xs" name="add_news"><i
                            class="fa fa-check"></i> <?= @$btn_name; ?>
                    </button>
                </div>
    ...
    function updateItem()
    {
        ...
        if($('#form-bk').validationEngine('validate')){
            $.ajax({
                type: "POST",
                dataType: "json",
                url: base_url() + 'adminvn/alias/checkNewEdit',
