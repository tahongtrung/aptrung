                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <div class="pull-right">
                                        <button onclick="updadteItem()" type="button" class="btn btn-success btn-xs" name="add_cate"><i
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5" id="error-alias">
                                            <input type="text" onchange="createAlias(this)" class="form-control input-sm validate[required]" name="alias"
                                                   id="alias" value="<?=@$edit->alias;?>" placeholder="Tên danh mục"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    function updadteItem()
    {
        ...
        if($('#form-bk').validationEngine('validate')){
            $.ajax({
                type: "POST",
                dataType: "json",
                url: base_url() + 'adminvn/alias/checkCatMediaEdit',
