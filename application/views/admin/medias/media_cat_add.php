        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-table"></i> <?=$btn_name;?> mục Media
                    </li>
                    <?php if(isset ($error)){?>
                        <li class="">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <div class="pull-right">
                                        <button type="button" onclick="createItem()" class="btn btn-success btn-xs" name="add_cate"><i
                                ...
                                <label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea name="description" class="form-control input-sm" placeholder="Mô tả" rows="7" ><?=@$edit->description;?></textarea>
                                        </div>
                                    </div>
                                    <div class="text-center">
                                        <input type="hidden" value="1" name="addcate">
                                        <button onclick="createItem()" type="button" class="btn btn-success btn-xs" name="add_cate"><i
                                                class="fa fa-check"></i> <?=$btn_name;?></button>
                                    </div>
                                </div>
                            </div>
