        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="body collapse in" id="div1">
                    <form class="form-horizontal" role="form" id="form-bk" method="POST" action="" enctype="multipart/form-data" >
                            ...
                            <div class="panel-default panel">
                                <div class="panel-heading">
                                    ...
                                    <div class="pull-right">
                                        <button type="button" onclick="updateHangsx()" class="btn btn-success btn-xs" name="addcate"><i
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <label for="inputEmail1" class="col-lg-2 control-label">Tên hãng sản xuất:</label>
                                        <div class="col-lg-5">
                                            <input type="text" oninput="createAlias(this)" class="form-control input-sm " name="name"
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail1" class="col-lg-2 control-label">Alias :</label>
                                        <div class="col-lg-5">
                                            <input type="text" onchange="createAlias(this)" id="alias" class="form-control input-sm " name="alias"
                                                   value="<?=@$edit->alias;?>" placeholder="Tên hãng"  />
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <input type="hidden" name="edit_hsx" value="1">
                                        <button type="button" onclick="updateHangsx()" class="btn btn-success btn-sm" name="addcate"><i class="fa fa-check"></i> <?=$btn_name;?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    function updateHangsx()
    {
        ...
        if($('#form-bk').validationEngine('validate')){
            $.ajax({
                type: "POST",
                dataType: "json",
                url: base_url() + 'adminvn/alias/checkHangsx',
