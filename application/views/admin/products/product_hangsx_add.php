                            ...
                            <div class="panel-default panel">
                                <div class="panel-heading">
                                    ...
                                    <div class="pull-right">
                                        <button type="button" onclick="createCate()" class="btn btn-success btn-xs" name="addcate"><i
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="inputEmail1" class="col-lg-2 control-label">Tên hãng:</label>
                                        <div class="col-lg-5">
                                            <input type="text" oninput="createAlias(this)" class="form-control input-sm validate[required]" name="name"
                                                   value="<?=@$edit->name;?>" placeholder="Tên hãng"  />
                                        </div>
                                       <div class="col-lg-5">
                                            <label >
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" onclick="createCate()" class="btn btn-success btn-sm" name="addcate"><i class="fa fa-check"></i> <?=$btn_name;?></button>
                                </div>
                            </div>
                        </div>
                    </div>
