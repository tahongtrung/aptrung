...
$list_info_baokim = $_SESSION['info_baokim'];
/*echo "<pre>";
var_dump($list_info_baokim);die();*/
?>
				...
				<div class="row-fluid customer_info ">
					<div class="info">
						...
						<dl class="dl-horizontal">
							...
							<dt>Họ tên:</dt>
							<dd><input type="text" name="payer_name" value="<?= $info[1]?>"></dd>
							<dt>Số điện thoại:</dt>
							<dd><input type="text" name="payer_phone_no" value="<?= $info[2]?>"></dd>
							<dt>Email:</dt>
							<dd><input type="text" name="payer_email" value="<?= $info[3]?>"></dd>
							<dt>Địa chỉ:</dt>
							<dd><input type="text" name="address" value="<?= $info[4]?>"></dd>
                                <dt>Số tiền thanh toán:</dt>
                                <dd style="margin-top: 5px; color:darkred; font-weight: bold">
                                    <?= number_format($info[5]); ?>&nbsp;<?=@$_SESSION['currentcy']?>
                                </dd>
